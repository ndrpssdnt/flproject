...
class EditOrder extends StatefulWidget {
  ...
  bool isPagato;
  bool isConsegnato;
  EditOrder({this.snapshot, this.isPagato, this.isConsegnato});
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              FCustomInput(
                  nome: "Cliente",
                  tcontroller: clienteController
                    ..text = widget.snapshot["cliente"]),
              Divider(),
              Padding(
                ...
                child: TextFormField(
                  ...
                  controller: descrizioneController
                    ..text = widget.snapshot["descrizione"],
              ...
              FCustomInput(
                ...
                tcontroller: importoController
                  ..text = widget.snapshot["importo"].toString(),
              ),
              Padding(
